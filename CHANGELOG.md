...
### Fixes
- Chat UI: fix streaming message animation black box flash by adding `isolation: isolate` stacking context and restoring shimmer effect with theme-aware gradients.
