...
本目录包含用于将 OpenClawCN 打包并部署到 WSL Ubuntu 的脚本。
...
```powershell
cd d:\codeknowledge\openclawcn-main\openclawcn-main
...
```powershell
.\scripts\deploy\deploy-ssh.ps1 -SSHHost "kevinUp" -SSHUser "kslinux"
```
...
| -RemotePath | /home/openclawcn | 部署目标路径 |
...
```powershell
# 启动
wsl -u kslinux bash -c 'cd /home/openclawcn && ./start.sh'

# 停止
wsl -u kslinux bash -c 'cd /home/openclawcn && ./stop.sh'

# 状态
wsl -u kslinux bash -c 'cd /home/openclawcn && ./status.sh'
```
...
- 环境配置: `/home/openclawcn/.env`
- OpenClawCN 配置: `~/.openclawcn/`
- 工作目录: `~/clawd/`
- 日志文件: `/home/openclawcn/logs/gateway.log`
...
# 查看日志
journalctl --user -u openclawcn-gateway -f
```
