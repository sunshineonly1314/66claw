...
show_usage() {
    cat << EOF
clawlog - OpenClawCN Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View OpenClawCN logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    OpenClawCN logs flow through the macOS unified log (subsystem: com.openclawcn).
