...
APP_BUNDLE="${1:-dist/OpenClawCN.app}"
IDENTITY="${SIGN_IDENTITY:-}"
TIMESTAMP_MODE="${CODESIGN_TIMESTAMP:-auto}"
DISABLE_LIBRARY_VALIDATION="${DISABLE_LIBRARY_VALIDATION:-0}"
SKIP_TEAM_ID_CHECK="${SKIP_TEAM_ID_CHECK:-0}"
ENT_TMP_BASE=$(mktemp -t openclawcn-entitlements-base.XXXXXX)
ENT_TMP_APP_BASE=$(mktemp -t openclawcn-entitlements-app-base.XXXXXX)
ENT_TMP_RUNTIME=$(mktemp -t openclawcn-entitlements-runtime.XXXXXX)
