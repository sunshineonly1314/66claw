...
# Output:
# - dist/OpenClawCN.app
# - dist/OpenClawCN-<version>.zip
# - dist/OpenClawCN-<version>.dmg
...
APP="$ROOT_DIR/dist/OpenClawCN.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OpenClawCN-$VERSION.zip"
DMG="$ROOT_DIR/dist/OpenClawCN-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OpenClawCN-$VERSION.notary.zip"
