...
if [[ -z "$version_content" ]]; then
  echo "<h2>OpenClawCN $VERSION</h2>"
  echo "<p>Latest OpenClawCN update.</p>"
  echo "<p><a href=\"https://github.com/openclawcn/openclawcn/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
