...
OutputBaseFilename=ClawdbotCN-Full-Setup-2026.2.0-x64
...
Source: "..\..\skills-merged\*"; DestDir: "{app}\skills"; Flags: ignoreversion recursesubdirs createallsubdirs skipifsourcedoesntexist
...
; Templates - bot default role config (CN build uses Chinese templates, PRODUCTION ONLY - exclude dev files)
Source: "..\..\docs-cn\reference\templates\*"; DestDir: "{app}\docs\reference\templates"; Excludes: "*.dev.md"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: "E:\clawdbuild\full-tools\gh.exe"; DestDir: "{app}\tools"; Flags: ignoreversion skipifsourcedoesntexist
Source: "E:\clawdbuild\full-tools\himalaya.exe"; DestDir: "{app}\tools"; Flags: ignoreversion skipifsourcedoesntexist
Source: "E:\clawdbuild\full-tools\yt-dlp.exe"; DestDir: "{app}\tools"; Flags: ignoreversion skipifsourcedoesntexist
Source: "E:\clawdbuild\full-tools\uv.exe"; DestDir: "{app}\tools"; Flags: ignoreversion skipifsourcedoesntexist
Source: "E:\clawdbuild\full-tools\rclone.exe"; DestDir: "{app}\tools"; Flags: ignoreversion skipifsourcedoesntexist
Source: "E:\clawdbuild\full-tools\ffmpeg.exe"; DestDir: "{app}\tools"; Flags: ignoreversion skipifsourcedoesntexist
Source: "E:\clawdbuild\full-tools\sherpa-onnx\*"; DestDir: "{app}\tools\sherpa-onnx"; Flags: ignoreversion recursesubdirs createallsubdirs skipifsourcedoesntexist
; README, LICENSE, CHANGELOG (distribution compliance)
Source: "..\..\README.md"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\README-header.png"; DestDir: "{app}"; Flags: ignoreversion
