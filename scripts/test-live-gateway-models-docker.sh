...
docker run --rm -t \
  ...
  -e OPENCLAWCN_LIVE_GATEWAY_MODELS="${OPENCLAWCN_LIVE_GATEWAY_MODELS:-all}" \
  -e OPENCLAWCN_LIVE_GATEWAY_PROVIDERS="${OPENCLAWCN_LIVE_GATEWAY_PROVIDERS:-}" \
  -e OPENCLAWCN_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${OPENCLAWCN_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}" \
