...
export function renderCron(props: CronProps) {
  ...
  return html`
    <section class="grid grid-cols-2">
      <div class="card">
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          ...
          <div class="stat">
            <div class="stat-label">${t("cron.jobsTitle")}</div>
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="card-sub">${t("cron.runHistoryDesc", { jobId: props.runsJobId ?? t("cron.selectJob") })}</div>
...
function renderScheduleFields(props: CronProps) {
  ...
  if (form.scheduleKind === "every") {
    return html`
      <div class="form-grid" style="margin-top: 12px;">
        <label class="field">
          <span>${t("cron.scheduleEvery")}</span>
          <input
  ...
  return html`
    <div class=${itemClass} @click=${() => props.onLoadRuns(job.id)}>
      <div class="list-main">
        ...
        ${job.agentId ? html`<div class="muted">${t("cron.agent")}: ${job.agentId}</div>` : nothing}
