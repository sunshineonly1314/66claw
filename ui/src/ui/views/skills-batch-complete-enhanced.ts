...
const SKILL_META: Record<string, { name: string; desc: string; category: string }> = {
  ...
  summarize: { name: "网页摘要", desc: "用AI一键<hl>摘要</hl>网页、视频和播客内容", category: "productivity" },
  oracle: { name: "Oracle", desc: "代码发给第二个AI做<hl>交叉审查</hl>", category: "productivity" },
  himalaya: { name: "邮件管理", desc: "管理 <hl>Gmail</hl>、<hl>Calendar</hl>、Drive", category: "productivity" },
  ...
  peekaboo: { name: "屏幕截图", desc: "macOS <hl>UI自动化</hl>：截图、窗口、菜单", category: "platform" },
  ...
  "apple-reminders": { name: "Apple 提醒事项", desc: "管理 Apple <hl>提醒事项</hl>", category: "platform" },
  slack: { name: "Slack 消息", desc: "发送和接收 <hl>Slack</hl> 消息", category: "dev" },
  "sherpa-onnx-tts": { name: "语音合成", desc: "AI<hl>语音合成</hl>，文字转语音", category: "media" },
...
export function renderSkillsBatchCompleteEnhanced(props: {
  ...
  function getSkillIcon(name: string): string {
    const icons: Record<string, string> = {
      weather: "🌤", summarize: "📝", oracle: "🔮", himalaya: "📨",
      mcporter: "🔌", openhue: "💡", "openai-whisper": "🗣️",
      peekaboo: "👁️", github: "🐙", "apple-notes": "📔",
      "apple-reminders": "✅", slack: "💬", "sherpa-onnx-tts": "🎙",
      camsnap: "📷", goplaces: "📍",
    };
    return icons[name] || "📦";
  }
