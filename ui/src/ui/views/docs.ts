...
function renderDocsReading(props: DocsViewProps) {
  ...
  if (!doc) {
    return html`<div class="docs-error">文档不存在</div>`;
  }
                  ...
                  (doc) => html`
                    ...
                    >
                      ...
                      <div class="docs-search-result-keywords">
                        ${doc.keywords.slice(0, 3).map(
                          (kw) => html`<span class="docs-keyword-tag">${kw}</span>`,
                        )}
                      </div>
                    </div>
                  `,
              ...
              : html`
                  <div class="docs-search-hint">
                    ...
                    <div class="docs-search-hint-list">
                      <div class="docs-search-hint-item">
                        输入 <code>安全</code> 查看安全相关文档
                      </div>
                      <div class="docs-search-hint-item">
                        输入 <code>telegram</code> 查看 Telegram 配置
                      </div>
                      <div class="docs-search-hint-item">
                        输入 <code>模型</code> 查看 AI 模型配置
                      </div>
                    </div>
                  </div>
                `}
