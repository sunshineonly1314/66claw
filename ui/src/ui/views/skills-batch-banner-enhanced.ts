...
const SKILL_FRIENDLY_NAMES: Record<string, string> = {
  ...
  mcporter: "MCP 工具", "apple-notes": "Apple 备忘录",
  "apple-reminders": "Apple 提醒事项", slack: "Slack 消息",
  trello: "Trello 看板", "sherpa-onnx-tts": "语音合成",
  "voice-call": "语音通话", bluebubbles: "iMessage 消息",
  // 更多技能...省略部分以保持代码简洁
};
  ...
  return html`
    <div class="skills-banner-enhanced">
      ...
      <div class="banner-skills-preview">
        ${props.missingSkills.slice(0, 5).map(skill => html`
