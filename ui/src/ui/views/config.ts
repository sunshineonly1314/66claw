...
export function renderConfig(props: ConfigProps) {
  const validity =
    props.valid == null ? t("common.unknown") : props.valid ? t("config.valid") : t("config.invalid");
      ...
      <main class="config-main">
        ...
        <div class="config-actions">
          <div class="config-actions__left">
            ${hasChanges ? html`
              <span class="config-changes-badge">${props.formMode === "raw" ? t("config.unsavedChanges") : t("config.unsavedChangesCount", { count: diff.length })}</span>
            ` : html`
        ...
        ${hasChanges && props.formMode === "form" ? html`
          <details class="config-diff">
            <summary class="config-diff__summary">
              <span>${t("config.viewPendingChanges", { count: diff.length })}</span>
