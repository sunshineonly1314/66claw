...
function renderCNExclusiveBadge(usingCNMirror?: boolean) {
  ...
  return html`
    <div class="skill-progress-cn-badge">
      ...
      <span class="skill-progress-cn-text">ClawdbotCN 专属 · 国内高速镜像</span>
    </div>
  `;
}
