...
describe("filterItems", () => {
  const items = [
    makeItem({ serverId: "fs", friendlyName: "文件管理", friendlyNameEn: "Filesystem", category: "filesystem", isOfficial: true, securityScore: 95, tags: ["file", "io"] }),
    makeItem({ serverId: "sql", friendlyName: "数据库", friendlyNameEn: "SQLite", category: "database", isOfficial: true, securityScore: 90, tags: ["database", "sql"] }),
    makeItem({ serverId: "search", friendlyName: "网页搜索", friendlyNameEn: "Web Search", category: "search", isOfficial: false, isNew: true, securityScore: 80, tags: ["search", "web"] }),
    makeItem({ serverId: "hue", friendlyName: "智能灯光", friendlyNameEn: "OpenHUE", category: "smarthome", isOfficial: false, securityScore: 70, tags: ["hue", "light"] }),
  ];
