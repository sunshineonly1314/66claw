...
function buildAdapter(host: AgentChatHost): ChatState {
  return {
    ...
    get sessionKey() { return host.agentChatSessionKey; },
    set sessionKey(v) { host.agentChatSessionKey = v; },
    get chatLoading() { return host.agentChatLoading; },
    set chatLoading(v) { host.agentChatLoading = v; },
    get chatMessages() { return host.agentChatMessages; },
    set chatMessages(v) { host.agentChatMessages = v; },
    get chatThinkingLevel() { return null; },
    set chatThinkingLevel(_v) { /* ignore */ },
    get chatSending() { return host.agentChatSending; },
    set chatSending(v) { host.agentChatSending = v; },
    get chatMessage() { return host.agentChatMessage; },
    set chatMessage(v) { host.agentChatMessage = v; },
    get chatAttachments() { return host.agentChatAttachments; },
    set chatAttachments(v) { host.agentChatAttachments = v; },
    get chatRunId() { return host.agentChatRunId; },
    set chatRunId(v) { host.agentChatRunId = v; },
    get chatStream() { return host.agentChatStream; },
    set chatStream(v) { host.agentChatStream = v; },
    get chatStreamStartedAt() { return host.agentChatStreamStartedAt; },
