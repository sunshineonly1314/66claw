...
metadata: {"openclawcn":{"emoji":"🍌","requires":{"bins":["uv"],"env":["GEMINI_API_KEY"]},"primaryEnv":"GEMINI_API_KEY","install":[{"id":"uv-brew","kind":"brew","formula":"uv","bins":["uv"],"label":"Install uv (brew)"},{"id":"uv-pip","kind":"uv","package":"uv","bins":["uv"],"label":"Install uv (pip/uv)"}]}}
---
