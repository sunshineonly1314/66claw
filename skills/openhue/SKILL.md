...
metadata: {"openclawcn":{"emoji":"💡","requires":{"bins":["openhue"]},"install":[{"id":"brew","kind":"brew","formula":"openhue/cli/openhue-cli","bins":["openhue"],"label":"安装 OpenHue CLI (brew)"},{"id":"download","kind":"download","url":"https://github.com/openhue/openhue-cli/releases/latest","bins":["openhue"],"label":"下载 openhue","os":["win32","linux"]}]}}
---
