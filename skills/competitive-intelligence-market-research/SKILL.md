...
name_zh: 竞品情报调研
description: 面向 B2B SaaS 的竞争情报服务，覆盖销售/人力资源/金融科技/运营科技四大领域共 24 种场景
description_zh: 面向 B2B SaaS 的竞争情报服务，覆盖销售/人力资源/金融科技/运营科技四大领域共 24 种场景
metadata: {"clawdbot":{"emoji":"🔍","homepage":"https://github.com/shashwatgtm","always":true}}
---
## **🎯 多维度导航器**

**本 skills 服务于多个维度的 B2B SaaS 公司。请找到您的路径：**
...
1. **“我是 A 轮创始人，正为销售团队制作竞品对抗卡（battle cards）”**  
   → 前往：**A1 节**（销售科技、A 轮、创始人主导型研究）

2. **“我是 B 轮 HR 科技公司的产品营销经理（PMM），需开展竞品分析以支持向上市场拓展（upmarket move）”**  
   → 前往：**B2 节**（人力资源科技、B 轮、专业级研究）

3. **“我是 C 轮金融科技公司的首席营销官（CMO），董事会要求提供市场格局分析”**  
   → 前往：**C3 节**（金融科技、C 轮及以上、战略级情报）

4. **“我是运营科技公司副总裁，面向印度零售客户销售，需评估市场规模”**  
   → 前往：**D1 节**（运营科技、印度市场测算）

---

# 📊 A 节：销售科技（Sales Tech）竞争情报

**何时使用本节：**
- 您的产品：销售互动平台、对话智能、销售赋能、销售辅导等
- 您的竞争对手：Gong、Outreach、Salesloft、Chorus、Apollo、ZoomInfo
- 您的买家：销售负责人、首席营收官（CRO）、营收运营（RevOps）人员
- 您的上市策略（Go-to-Market）：产品驱动增长（PLG）或销售驱动，面向中小企业（SMB）/中端市场
...
**目标：** 输出定位简报（positioning deck）+ 销售团队用竞品对抗卡（battle cards）
...
# 📊 B 节：人力资源科技（HR Tech）竞争情报

**何时使用本节：**
- 您的产品：人力资源信息系统（HRIS）、员工敬业度、绩效管理、招聘、学习与发展等
- 您的竞争对手：Workday、BambooHR、Culture Amp、Lattice、Lever、Greenhouse
- 您的买家：HR 负责人、首席人力资源官（CHRO）、人力运营（People Ops）人员
- 您的上市策略：通常为销售驱动（HR 决策高度依赖关系）

---

## **B1：A 轮人力资源科技（创始人主导型研究）**
...
# 📊 C 节：金融科技（Fintech）竞争情报

**何时使用本节：**
- 您的产品：支付、费用管理、企业信用卡、薪资发放、新银行（neo-banking）等
- 您的竞争对手：Razorpay、Paytm、PhonePe（印度）、Stripe、Brex、Ramp（美国）
- 您的买家：首席财务官（CFO）、财务负责人、财务主管（Controllers）
- 您的上市策略：销售驱动（财务决策者风险厌恶倾向强）
- **关键提示**：属强监管行业，必须坚持“合规优先”
...
# 📊 D 节：运营科技（Operations Tech）竞争情报

**何时使用本节：**
- 您的产品：零售执行、物流、外勤人员自动化、路线优化等
- 您的竞争对手：FieldAssist、Bizom、Ivy Mobility（印度）、Repsly（美国）
- 您的买家：快消品（CPG）/日用品（FMCG）企业的销售负责人、运营负责人
- 您的上市策略：企业级销售（周期长、需试点）
- **B2B2C 复杂性**：您服务的是面向终端消费者的企业客户
...
### **案例 2：人力资源科技产品营销经理（PMM），B 轮，模块扩展决策**
...
| 工具 | A 轮 | B 轮 | C 轮及以上 | 最适用场景 | 所属行业 |
|------|----------|----------|-----------|----------|----------|
| **Google 搜索** | ✅ 免费 | ✅ 可用 | ✅ 可用 | 所有场景 | 所有行业 |
| **LinkedIn（免费版）** | ✅ 免费 | ✅ 可用 | ✅ 可用 | 所有场景 | 所有行业 |
| **G2/Capterra** | ✅ 免费 | ✅ 可用 | ✅ 可用 | 评论挖掘 | 所有行业 |
| **Crunchbase 免费版** | ✅ 免费 | ⚠️ 功能受限 | ⚠️ 功能受限 | 融资数据 | 所有行业 |
| | | | | | |
| **LinkedIn Sales Navigator** | 💰 $99 | ✅ 是 | ✅ 是 | ICP 规模测算、组织架构图 | 所有行业 |
| **Crunchbase Pro** | 💰 $29 | ✅ 是 | ✅ 是 | 竞品融资数据 | 所有行业 |
| **SimilarWeb** | ❌ 跳过 | ✅ $125 | ✅ 是 | 流量分析 | 销售科技/营销科技 |
| **Ahrefs** | ❌ 跳过 | ⚠️ $99 | ✅ 是 | SEO 竞争分析 | 销售科技/营销科技 |
| **G2 Track** | ❌ 跳过 | ⚠️ $150 | ✅ 是 | 评论监控 | 人力资源科技 |
| | | | | | |
| **Gartner** | ❌ 不适用 | ❌ 或许适用 | ✅ $35K+ | 分析师接入、魔力象限（MQ） | 人力资源科技、企业级 |
| **Klue/Crayon** | ❌ 不适用 | ❌ 或许适用 | ✅ $18K+ | 竞争情报平台 | C 轮及以上所有行业 |
| **ZoomInfo** | ❌ 不适用 | ❌ 或许适用 | ✅ $20K+ | 联系人数据 | C 轮及以上所有行业 |
| | | | | | |
| **Vanta/Drata** | ⚠️ 金融科技 | ✅ 金融科技 | ✅ 所有行业 | SOC 2 合规性 | 金融科技、人力资源科技、运营科技 |
| **法律顾问** | ✅ 金融科技 | ✅ 金融科技 | ✅ 所有行业 | 监管合规 | 金融科技（强制要求） |
...
### **问题 3：“竞品处于隐身模式（stealth mode），无公开信息”**
...
- **内容创作与思想领导力** —— 将竞争洞察转化为思想领导力内容  
- **个人品牌建设与权威塑造** —— 将自身定位为市场专家  
- **新闻简报（Newsletter）创建** —— 向潜在客户分享市场情报  
- **社交媒体管理** —— 放大竞争洞察影响力  
