 ...
 *
 * 数据来源:
 * 1. cn/skills-qc/output-all/skills-index.json (1,190 个质量评估后技能)
...
console.log(`\n📊 从 cn/skills-qc 新增: ${addedFromQingxi.names} 名称, ${addedFromQingxi.descs} 描述`);
