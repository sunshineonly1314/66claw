...
try {
    ...
    # 复制部署脚本
    Copy-Item -Force "$ProjectRoot\nativedeploy\setup.sh" "$DeployDir\"
    Copy-Item -Force "$ProjectRoot\nativedeploy\start.sh" "$DeployDir\"
    Copy-Item -Force "$ProjectRoot\nativedeploy\stop.sh" "$DeployDir\"
    Copy-Item -Force "$ProjectRoot\nativedeploy\status.sh" "$DeployDir\"
