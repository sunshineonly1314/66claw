 ...
 *
 * Phase 1: Built and tested but NOT yet integrated into the message flow.
 * Phase 2: Becomes the first layer of the Fast Path Router
 *          (session affinity → keyword → intent → LLM fallback).
 *
...
export function extractKeywordsFromRole(roleDescription: string): string[] {
  ...
  // Split on punctuation, spaces, common separators, Chinese conjunctions,
