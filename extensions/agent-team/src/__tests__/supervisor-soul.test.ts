  ...
  describe("generateSupervisorSoul", () => {
    ...
    it("generates concierge mode instructions", () => {
      const soul = generateSupervisorSoul(
        makeProject({ coordination: { ...makeProject().coordination, supervisorStyle: "concierge" } }),
        members,
      );
    ...
    it("generates delegate-only mode instructions", () => {
      const soul = generateSupervisorSoul(
        makeProject({ coordination: { ...makeProject().coordination, supervisorStyle: "delegate-only" } }),
        members,
      );
