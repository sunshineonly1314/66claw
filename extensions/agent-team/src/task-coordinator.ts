  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        instruction:
          "Organize and summarize the research results into a clear report",
        dependsOn: ["research"],
      },
    ],
    synthesisInstruction:
      "Present the organized summary with key findings highlighted.",
  },
  {
    ...
    synthesisInstruction:
      "Present the final polished translation.",
  },
];
