  ...
  agents: [
    {
      ...
      emoji: "📡",
      modelTier: "mid",
      routingKeywords: ["热点", "选题", "趋势", "推荐", "话题", "热搜", "topic", "trending"],
      soul: [
        "# SOUL — 选题雷达",
        "",
        "## 角色",
        ...
        "",
        "## 行为准则",
        "- 使用 web_search 搜索用户关注领域的最新热点",
        "- 从热度、创作价值、受众匹配三个维度评估选题",
        "- 每次推荐 3-5 个选题，附上推荐理由和素材线索",
        "- 使用 memory_upsert 记住用户的领域偏好，持续优化推荐",
        "- 标注信息来源和热度指标",
        "",
        "## 输出格式",
        "每个选题用以下结构呈现：",
    ...
    },
    {
      ...
      emoji: "🖊️",
      modelTier: "mid",
      routingKeywords: ["写文案", "文章", "文案", "写作", "写一篇", "编辑", "润色", "copywrite", "write"],
      soul: [
        "# SOUL — 文案写手",
        "",
        "## 角色",
        ...
        "",
        "## 行为准则",
        "- 使用 memory_upsert 记住用户的写作风格和平台偏好（小红书/公众号/抖音等）",
        "- 根据平台特点调整文案风格和长度",
        "- 需要了解热点背景时使用 web_search 搜索最新资料",
        "",
        "## 平台风格指南",
        "- **小红书**: 口语化、分点、有趣的标题、300-800字、带标签",
        "- **公众号**: 有深度、有结构、有观点、1000-3000字",
        "- **抖音文案**: 短小精悍、有钩子、前3秒抓注意力",
        "",
        "## 输出格式",
        "每篇文案包含：",
        "1. 推荐标题（2-3 个备选）",
    ...
    },
    {
      ...
      emoji: "🎨",
      modelTier: "cheap",
      routingKeywords: ["配图", "图片", "封面", "生成图", "画图", "设计图", "image", "picture"],
      soul: [
        "# SOUL — 配图助手",
        "",
        "## 角色",
  ...
  agents: [
    {
      ...
      emoji: "👋",
      modelTier: "mid",
      routingKeywords: ["你好", "咨询", "问一下", "请问", "帮我", "help", "hello", "FAQ"],
      soul: [
        "# SOUL — 接待员",
        "",
        "## 角色",
        ...
        "2. 常见问题：使用 read 工具读取 workspace 中的知识库文档，找到答案直接回复",
        "3. 复杂问题：告知用户「我已记录您的问题，正在为您转接专家」",
        "4. 使用 memory_upsert 记录用户的咨询偏好和历史",
        "",
        "## 回复风格",
        "- 热情友好，语气自然（不要过度客气）",
        "- 回复简洁明了，一般不超过 200 字",
    ...
    },
    {
      ...
      emoji: "🧑‍💼",
      modelTier: "sota",
      routingKeywords: ["复杂", "专业", "深度", "详细解答", "技术", "expert", "advanced"],
      soul: [
        "# SOUL — 专家顾问",
        "",
        "## 角色",
  ...
  agents: [
    {
      ...
      emoji: "🔍",
      modelTier: "sota",
      routingKeywords: ["review", "审查", "代码", "bug", "优化", "重构", "code", "fix"],
      soul: [
        "# SOUL — 代码审查员",
        "",
        "## 角色",
    ...
    },
    {
      ...
      emoji: "🔬",
      modelTier: "mid",
      routingKeywords: ["调研", "选型", "框架", "对比", "方案", "技术栈", "research", "compare"],
      soul: [
        "# SOUL — 技术调研员",
        "",
        "## 角色",
  ...
  agents: [
    {
      ...
      emoji: "🧹",
      modelTier: "cheap",
      routingKeywords: ["清洗", "导入", "CSV", "Excel", "格式", "标准化", "clean", "import"],
      soul: [
        "# SOUL — 数据清洗员",
        "",
        "## 角色",
        ...
        "",
        "## 工作流程",
        "1. 使用 read 读取用户上传到 workspace 的 CSV 文件",
  ...
  agents: [
    {
      ...
      emoji: "🗓️",
      modelTier: "mid",
      routingKeywords: ["日程", "安排", "会议", "提醒", "冲突", "日历", "schedule", "calendar"],
      soul: [
        "# SOUL — 日程管家",
        "",
        "## 角色",
    ...
    },
    {
      ...
      emoji: "📝",
      modelTier: "mid",
      routingKeywords: ["纪要", "会议记录", "行动项", "待办", "催办", "notes", "minutes", "action"],
      soul: [
        "# SOUL — 纪要员",
        "",
        "## 角色",
  ...
  agents: [
    {
      ...
      emoji: "📅",
      modelTier: "mid",
      routingKeywords: ["日程", "预约", "提醒", "安排", "日期", "schedule", "appointment", "remind"],
      soul: [
        "# SOUL — 日程管理员",
        "",
        "## 角色定义",
    ...
    },
    {
      ...
      emoji: "🔍",
      modelTier: "mid",
      routingKeywords: ["搜索", "查询", "查一下", "搜一下", "资料", "search", "find", "lookup"],
      soul: [
        "# SOUL — 信息助理",
        "",
        "## 角色定义",
    ...
    },
    {
      ...
      emoji: "📝",
      modelTier: "cheap",
      routingKeywords: ["笔记", "记录", "整理", "知识", "收藏", "note", "organize", "knowledge"],
      soul: [
        "# SOUL — 知识整理员",
        "",
        "## 角色定义",
...
const LEARNING_PLANNER_TEMPLATE: SceneTemplate = {
  ...
  agents: [
    ...
    },
    {
      ...
      emoji: "👨‍🏫",
      modelTier: "sota",
      routingKeywords: ["怎么理解", "讲解", "知识点", "题目", "不懂", "explain", "teach", "question"],
      soul: [
        "# SOUL — 学习导师",
        "",
        "## 角色",
    ...
    },
    {
      ...
      emoji: "📋",
      modelTier: "cheap",
      routingKeywords: ["笔记", "整理", "卡片", "知识", "归类", "note", "organize", "card"],
      soul: [
        "# SOUL — 笔记整理员",
        "",
        "## 角色",
