...
import type { ClawdbotPluginService, DiagnosticEventPayload } from "openclawcn/plugin-sdk";
import { onDiagnosticEvent, registerLogTransport } from "openclawcn/plugin-sdk";
