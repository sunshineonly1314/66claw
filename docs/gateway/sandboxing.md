---
summary: "How OpenClawCN sandboxing works: modes, scopes, workspace access, and images"
title: Sandboxing
...
OpenClawCN can run **tools inside Docker containers** to reduce blast radius.
...
OpenClawCN mirrors eligible skills into the sandbox workspace (`.../skills`) so
...
Default image: `openclawcncn-sandbox:bookworm-slim`
...
- Use `openclawcn sandbox explain` to inspect effective sandbox mode, tool policy, and fix-it config keys.
