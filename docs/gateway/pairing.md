...
openclawcn nodes reject <requestId>
openclawcn nodes status
openclawcn nodes rename --node <id|name|ip> --name "Living Room iPad"
```
...
If you override `OPENCLAWCN_STATE_DIR`, the `nodes/` folder moves with it.
