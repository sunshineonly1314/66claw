...
read_when:
  ...
  - Wiring external systems into OpenClawCN
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your OpenClawCN config directory (typically `~/.openclawcn/hooks/transforms`).
...
- `openclawcn webhooks gmail setup` writes `hooks.gmail` config for `openclawcn webhooks gmail run`.
