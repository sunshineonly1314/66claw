...
- **描述**: OpenClaw/OpenClawCN 的中国 IM 平台扩展插件集合
- **支持平台**:
  | 平台 | 状态 |
  |------|------|
  | 钉钉 | ✅ 可用 |
...
## MoltBot China vs OpenClawCN 对比分析

### 项目定位差异

| 维度 | MoltBot China | OpenClawCN (我们) |
|------|---------------|-----------------|
...
| 功能 | MoltBot China 钉钉 | OpenClawCN 钉钉 | 优势方 |
|------|-------------------|---------------|--------|
...
| 功能 | MoltBot China 飞书 | OpenClawCN 飞书 | 优势方 |
|------|-------------------|---------------|--------|
...
| 功能 | MoltBot China 企微 | OpenClawCN 企微 | 优势方 |
|------|-------------------|---------------|--------|
