...
- Same path: run the app from a fixed location (for OpenClawCN, `dist/OpenClawCN.app`).
...
```bash
sudo tccutil reset Accessibility com.openclawcn.mac
sudo tccutil reset ScreenCapture com.openclawcn.mac
