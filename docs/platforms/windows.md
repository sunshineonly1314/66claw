...
### Option 1: Pre-built WSL Package (Recommended)

Download the pre-built WSL package for the fastest setup:
...
The WSL package includes:
- Auto-opens configuration page in Windows browser (via wslview/cmd.exe)
- Windows desktop shortcut creation (`./create-windows-shortcut.sh`)
- Background daemon support (`./start-daemon.sh`)
...
- [Windows Build Guide](/windowsbuild) for building packages
