...
<Tabs>
  <Tab title="Socket Mode (default)">
    <Steps>
      ...
      <Step title="Configure OpenClawCN">
...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure OpenClawCN HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `openclawcn pairing approve slack <code>`.
...
```json
{
  "display_information": {
    "name": "OpenClawCN",
    "description": "Slack connector for OpenClawCN"
  },
  "features": {
    "bot_user": {
      "display_name": "OpenClawCN",
      "always_online": false
    },
    "app_home": {
    ...
    "slash_commands": [
      {
        "command": "/openclawcn",
        "description": "Send a message to OpenClawCN",
        "should_escape": false
      }
    ]
  },
