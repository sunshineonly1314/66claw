---
summary: "Use NVIDIA's OpenAI-compatible API in OpenClawCN"
read_when:
  - You want to use NVIDIA models in OpenClawCN
...
openclawcn onboard --auth-choice skip
openclawcn models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
