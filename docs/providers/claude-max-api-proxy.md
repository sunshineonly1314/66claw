...
You can point OpenClawCN at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OpenClawCN
...
- [Anthropic provider](/providers/anthropic) - Native OpenClawCN integration with Claude setup-token or API keys
