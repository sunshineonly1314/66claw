---
summary: "Use MiniMax M2.1 in OpenClawCN"
read_when:
  - You want MiniMax models in OpenClawCN
...
Configure manually via `openclawcn.json`:
...
- Use `openclawcn models list` and `openclawcn models set minimax/MiniMax-M2.1` to switch.
...
- Running `openclawcn configure` and selecting **MiniMax M2.1**, or
