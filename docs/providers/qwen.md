---
summary: "Use Qwen OAuth (free tier) in OpenClawCN"
read_when:
  - You want to use Qwen with OpenClawCN
...
```bash
openclawcn models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, OpenClawCN will sync credentials
