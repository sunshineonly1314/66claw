...
Deepgram is a speech-to-text API. In OpenClawCN it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, OpenClawCN uploads the audio file to Deepgram and injects the transcript
