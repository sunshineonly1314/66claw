---
summary: "Model providers (LLMs) supported by OpenClawCN"
read_when:
...
OpenClawCN can use many LLM providers. Pick one, authenticate, then set the default
...
1) Authenticate with the provider (usually via `openclawcn onboard`).
