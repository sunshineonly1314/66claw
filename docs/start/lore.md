---
summary: "Backstory and lore of OpenClawCN for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
---
# The Lore of OpenClawCN 🦞📖
...
For a brief moment, it had a different name — but everyone liked **OpenClawCN** more, so that's what we settled on.
...
And so **OpenClawCN** was born.

## The Name

```
OpenClawCN = CLAW + TARDIS
