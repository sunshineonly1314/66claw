...
OpenClawCN has two separate “streaming” layers:
...
When block streaming is enabled, OpenClawCN can **merge consecutive block chunks**
...
When draft streaming is active, OpenClawCN disables block streaming for that reply to avoid double-streaming.
