 ...
 *
 * 用法:
 *   npx tsx skillsqingxi/batch-wash.ts --batch 1       # 清洗第 1 批（1-300）
 *   npx tsx skillsqingxi/batch-wash.ts --batch 2       # 清洗第 2 批（301-600）
 *   npx tsx skillsqingxi/batch-wash.ts --resume        # 从上次中断处继续
 *   npx tsx skillsqingxi/batch-wash.ts --review 1      # Review 第 1 批结果
 *   npx tsx skillsqingxi/batch-wash.ts --restore skill-name  # 将误判技能恢复到 accepted
 */
...
const BATCH_CONFIG = {
  ...
  outputDir: "./skillsqingxi/output-batch", // 批量输出目录
  batchSize: 300,                          // 每批 300 个
  checkpointFile: "./skillsqingxi/output-batch/checkpoint.json",
  reviewDir: "./skillsqingxi/output-batch/review", // review 标注目录
};
...
║                                                          ║
║  用法:                                                   ║
║    npx tsx skillsqingxi/batch-wash.ts --batch N         ║
║    npx tsx skillsqingxi/batch-wash.ts --resume          ║
║    npx tsx skillsqingxi/batch-wash.ts --review N        ║
║    npx tsx skillsqingxi/batch-wash.ts --restore <name>  ║
║                                                          ║
║  示例:                                                   ║
