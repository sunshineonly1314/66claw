 ...
 *
 * 用法:
 *   npx tsx skillsqingxi/optimize-prompts.ts --analyze    # 分析误判模式
 *   npx tsx skillsqingxi/optimize-prompts.ts --suggest    # 生成优化建议
 */
...
const REVIEW_DIR = "./skillsqingxi/output-batch/review";
...
function suggestOptimizations(): void {
  ...
  console.log(`\n🎯 下一步操作:`);
  console.log(`   1. 根据建议修改 skillsqingxi/layer1-rules.ts`);
  console.log(`   2. 根据建议修改 skillsqingxi/layer2-security.ts SYSTEM_PROMPT`);
  console.log(`   3. 根据建议修改 skillsqingxi/layer3-quality.ts 评分逻辑`);
