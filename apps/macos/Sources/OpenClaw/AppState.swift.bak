...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OpenClawCNConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OpenClawCNConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = OpenClawCNConfigFile.loadDict()
            ...
            OpenClawCNConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/openclawcn"
        state.remoteCliPath = ""
        return state
    }
}
