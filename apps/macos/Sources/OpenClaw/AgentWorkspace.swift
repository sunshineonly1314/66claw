...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.openclawcn", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OpenClawCNConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - OpenClawCN Workspace
