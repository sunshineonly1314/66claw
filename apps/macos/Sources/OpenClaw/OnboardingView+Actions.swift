...
extension OnboardingView {
    ...
    func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .openclawcnSelectSettingsTab, object: tab)
        }
    }
    ...
    func finishAnthropicOAuth() async {
        ...
        do {
            ...
            try OpenClawCNOAuthStore.saveAnthropicOAuth(creds)
            self.refreshAnthropicOAuthStatus()
            self.anthropicAuthStatus = "Connected. OpenClawCN can now use Claude."
        } catch {
