...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.openclawcn", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OpenClawCN windows, but below the system’s pop-up menus.
