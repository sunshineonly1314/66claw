...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.openclawcn", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        OpenClawCNPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        OpenClawCNPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
