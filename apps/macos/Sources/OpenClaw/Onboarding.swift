...
enum UIStrings {
    static let welcomeTitle = "Welcome to OpenClawCN"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "openclawcn.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: OpenClawCNOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: OpenClawCNChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g openclawcn@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OpenClawCNChatViewModel(
