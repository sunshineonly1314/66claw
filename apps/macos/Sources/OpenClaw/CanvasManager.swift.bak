...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.openclawcn", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("OpenClawCN/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__openclawcncn__/a2ui/").absoluteString + "?platform=macos"
    }
