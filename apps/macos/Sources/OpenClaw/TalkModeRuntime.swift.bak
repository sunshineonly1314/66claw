...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.openclawcn", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.openclawcn", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OpenClawCNChatMessage] = messages.compactMap { item in
