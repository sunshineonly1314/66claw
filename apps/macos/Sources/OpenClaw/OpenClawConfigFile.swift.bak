...
enum OpenClawCNConfigFile {
    private static let logger = Logger(subsystem: "ai.openclawcn", category: "config")
    private static let configAuditFileName = "config-audit.jsonl"

    static func url() -> URL {
        OpenClawCNPaths.configURL
    }

    static func stateDirURL() -> URL {
        OpenClawCNPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        OpenClawCNPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-openclawcncn-config-file",
            "event": "config.write",
