...
actor CameraCaptureService {
    ...
    private let logger = Logger(subsystem: "ai.openclawcn", category: "camera")
        ...
        outPath: String?) async throws -> (path: String, durationMs: Int, hasAudio: Bool)
    {
        ...
        let tmpMovURL = FileManager().temporaryDirectory
            .appendingPathComponent("openclawcncn-camera-\(UUID().uuidString).mov")
        ...
        let outputURL: URL = {
            ...
            return FileManager().temporaryDirectory
                .appendingPathComponent("openclawcncn-camera-\(UUID().uuidString).mp4")
        }()
