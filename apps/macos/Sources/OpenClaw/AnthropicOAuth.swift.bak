...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (OpenClawCN token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: OpenClawCNOAuthStore.AnthropicOAuthStatus = OpenClawCNOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.openclawcn", category: "anthropic-oauth")
...
enum OpenClawCNOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let openclawcnOAuthDirEnv = "OPENCLAWCN_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "OpenClawCN OAuth token file not found"
            case .unreadableFile: "OpenClawCN OAuth token file not readable"
            case .invalidJSON: "OpenClawCN OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in OpenClawCN OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "OpenClawCN OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.openclawcnOAuthDirEnv]?
        ...
        return home.appendingPathComponent(".openclawcn", isDirectory: true)
