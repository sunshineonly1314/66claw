...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/openclawcn/openclawcn") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/openclawcn/openclawcn")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://openclawcncn.com")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "OpenClawCNBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenClawCNBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OpenClawCNGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenClawCNGitCommit") as? String) ??
            "unknown"
    }
