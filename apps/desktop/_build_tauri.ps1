...
Write-Host "=== Tauri Build v1.1.23 (MSVC + Rust stable, JOBS=1) ===" -ForegroundColor Cyan
...
if ($exitCode -eq 0) {
    ...
    $nsisExe = Get-ChildItem "D:\codeknowledge\clawdbot-main\clawdbot-main\apps\desktop\src-tauri\target\release\bundle\nsis\*.exe" -ErrorAction SilentlyContinue | Select-Object -First 1
    if ($nsisExe) {
