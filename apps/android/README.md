## OpenClawCN Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_openclawcn-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm openclawcn gateway --port 18789 --verbose
```
