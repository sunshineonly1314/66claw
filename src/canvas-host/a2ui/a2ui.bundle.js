...
var OpenClawCNA2UIHost = class extends i$6 {
	static properties = {
		surfaces: { state: true },
    ...
    :host {
      ...
      box-sizing: border-box;
      padding:
        var(--openclawcn-a2ui-inset-top, 0px)
        var(--openclawcn-a2ui-inset-right, 0px)
        var(--openclawcn-a2ui-inset-bottom, 0px)
        var(--openclawcn-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--openclawcn-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--openclawcn-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--openclawcn-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--openclawcn-a2ui-empty-top, var(--openclawcn-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  `;
	connectedCallback() {
		...
		globalThis.addEventListener("openclawcn:a2ui-action-status", this.#statusListener);
		this.#syncSurfaces();
	}
	disconnectedCallback() {
		super.disconnectedCallback();
		if (this.#statusListener) {
			globalThis.removeEventListener("openclawcn:a2ui-action-status", this.#statusListener);
	...
	#handleA2UIAction(evt) {
		...
		globalThis.__openclawcnLastA2UIAction = userAction;
		const handler = globalThis.webkit?.messageHandlers?.openclawcnCanvasA2UIAction ?? globalThis.openclawcnCanvasA2UIAction;
		if (handler?.postMessage) {
			try {
				if (handler === globalThis.openclawcnCanvasA2UIAction) {
...
customElements.define("openclawcn-a2ui-host", OpenClawCNA2UIHost);
