...
type AgentEntry = NonNullable<NonNullable<OpenClawCNConfig["agents"]>["list"]>[number];
...
function listAgents(cfg: OpenClawCNConfig): AgentEntry[] {
...
export function listAgentIds(cfg: OpenClawCNConfig): string[] {
...
export function resolveDefaultAgentId(cfg: OpenClawCNConfig): string {
  const agents = listAgents(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: OpenClawCNConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentWorkspaceDir(cfg: OpenClawCNConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: OpenClawCNConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
