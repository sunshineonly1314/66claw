...
function resolveWatchPaths(workspaceDir: string, config?: OpenClawCNConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OpenClawCNConfig): string[] {
  ...
  for (const root of resolveWatchPaths(workspaceDir, config)) {
    ...
    targets.add(`${globRoot}/SKILL.md.enc`);
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenClawCNConfig }) {
