 ...
 *
 * Skills marketplace SQLite 存储层的类型定义
 */
...
export interface SkillMarketplaceItem {
  /** 技能唯一标识（= ProxySkillMeta.skillId / RemoteSkillMeta.name） */
  skillId: string;
  /** 英文名称 */
  name: string;
  /** 中文名称 */
...
export interface SkillSearchOptions {
  ...
  /** 是否已安装 */
  installed?: boolean;
  /** 数据来源过滤（proxy = 可下载, qc = 仅评测数据, availability-dict = 可用性数据） */
  source?: "proxy" | "qc" | "availability-dict";
  /** 排序字段 */
