...
const GOOGLE_LIVE_SINGLE_KEY = "OPENCLAWCN_LIVE_GEMINI_KEY";
...
const PROVIDER_API_KEY_CONFIG: Record<string, Omit<ProviderApiKeyConfig, "fallbackVars">> = {
  anthropic: {
    liveSingle: "OPENCLAWCN_LIVE_ANTHROPIC_KEY",
    listVar: "OPENCLAWCN_LIVE_ANTHROPIC_KEYS",
  ...
  openai: {
    liveSingle: "OPENCLAWCN_LIVE_OPENAI_KEY",
    listVar: "OPENAI_API_KEYS",
    primaryVar: "OPENAI_API_KEY",
    prefixedVar: "OPENAI_API_KEY_",
  },
  siliconflow: {
    liveSingle: "OPENCLAWCN_LIVE_SILICONFLOW_KEY",
    listVar: "SILICONFLOW_API_KEYS",
    primaryVar: "SILICONFLOW_API_KEY",
    prefixedVar: "SILICONFLOW_API_KEY_",
  },
  "kimi-coding": {
    liveSingle: "OPENCLAWCN_LIVE_KIMI_KEY",
    listVar: "KIMI_API_KEYS",
    primaryVar: "KIMI_API_KEY",
    prefixedVar: "KIMI_API_KEY_",
  },
  dashscope: {
    liveSingle: "OPENCLAWCN_LIVE_DASHSCOPE_KEY",
    listVar: "DASHSCOPE_API_KEYS",
    primaryVar: "DASHSCOPE_API_KEY",
    prefixedVar: "DASHSCOPE_API_KEY_",
  },
  "aliyun-codeplan": {
    liveSingle: "OPENCLAWCN_LIVE_ALIYUN_CODEPLAN_KEY",
    listVar: "ALIYUN_CODEPLAN_API_KEYS",
    primaryVar: "ALIYUN_CODEPLAN_API_KEY",
    prefixedVar: "ALIYUN_CODEPLAN_API_KEY_",
  },
  "glm-codeplan": {
    liveSingle: "OPENCLAWCN_LIVE_GLM_CODEPLAN_KEY",
    listVar: "GLM_CODEPLAN_API_KEYS",
    primaryVar: "GLM_CODEPLAN_API_KEY",
    prefixedVar: "GLM_CODEPLAN_API_KEY_",
  },
  "minimax-codeplan": {
    liveSingle: "OPENCLAWCN_LIVE_MINIMAX_CODEPLAN_KEY",
    listVar: "MINIMAX_CODEPLAN_API_KEYS",
    primaryVar: "MINIMAX_CODEPLAN_API_KEY",
    prefixedVar: "MINIMAX_CODEPLAN_API_KEY_",
  },
};
...
function resolveProviderApiKeyConfig(provider: string): ProviderApiKeyConfig {
  ...
  const liveSingle = custom?.liveSingle ?? `OPENCLAWCN_LIVE_${base}_KEY`;
