...
const CLEANUP_STATE_KEY = Symbol.for("openclawcn.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("openclawcn.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("openclawcn.sessionWriteLockWatchdogState");
...
function releaseAllLocksSync(): void {
  // Stop the watchdog first to prevent it from racing with sync cleanup
