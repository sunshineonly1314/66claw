...
import { resolveOpenClawCNDocsPath } from "../../docs-path.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const docsPath = await resolveOpenClawCNDocsPath({
      workspaceDir: effectiveWorkspace,
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/openclawcn/openclawcn/issues/9282
      ...
      // See: https://github.com/openclawcn/openclawcn/issues/8643
      await flushPendingToolResultsAfterIdle({
        agent: session?.agent,
        sessionManager,
      });
