...
const ANTHROPIC_OPUS_TEMPLATE_MODEL_IDS = ["claude-opus-4-6", "claude-opus-4.5"] as const;
...
const ANTIGRAVITY_OPUS_TEMPLATE_MODEL_IDS = ["claude-opus-4-6", "claude-opus-4.5"] as const;
...
export const ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES = [
  ...
  },
  {
    ...
    templatePrefixes: ["google-antigravity/claude-opus-4-6", "google-antigravity/claude-opus-4.5"],
  },
] as const;
...
function resolveAnthropicOpus46ForwardCompatModel(
  ...
  if (lower.startsWith(ANTHROPIC_OPUS_46_MODEL_ID)) {
    templateIds.push(lower.replace(ANTHROPIC_OPUS_46_MODEL_ID, "claude-opus-4-6"));
  }
...
function resolveAntigravityOpus46ForwardCompatModel(
  ...
  if (lower.startsWith(ANTIGRAVITY_OPUS_46_MODEL_ID)) {
    templateIds.push(lower.replace(ANTIGRAVITY_OPUS_46_MODEL_ID, "claude-opus-4-6"));
  }
  ...
  if (lower.startsWith(ANTIGRAVITY_OPUS_46_THINKING_MODEL_ID)) {
    templateIds.push(
      lower.replace(ANTIGRAVITY_OPUS_46_THINKING_MODEL_ID, "claude-opus-4-6-thinking"),
    );
  }
