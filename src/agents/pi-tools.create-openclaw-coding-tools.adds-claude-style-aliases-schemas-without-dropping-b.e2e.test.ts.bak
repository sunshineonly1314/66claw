...
describe("createOpenClawCNCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createOpenClawCNCodingTools({
      config,
    ...
    const anthropicTools = createOpenClawCNCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createOpenClawCNCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createOpenClawCNCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
