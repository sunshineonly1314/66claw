...
describe("buildSandboxCreateArgs", () => {
  it("includes hardening and resource flags", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "openclawcn-sbx-test",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
      labels: { "openclawcn.sandboxBrowser": "1" },
    });
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "openclawcn-sbx-test",
        "--label",
        "openclawcn.sandbox=1",
        "--label",
        "openclawcn.sessionKey=main",
        "--label",
        "openclawcn.createdAtMs=1700000000000",
        "--label",
        "openclawcn.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
