...
export function applyLitellmProviderConfig(cfg: OpenClawCNConfig): OpenClawCNConfig {
...
export function applyLitellmConfig(cfg: OpenClawCNConfig): OpenClawCNConfig {
