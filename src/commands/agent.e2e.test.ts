...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "openclawcn-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<OpenClawCNConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<OpenClawCNConfig["telegram"]>>,
