 ...
 * 应用硅基流动默认配置
 */
export function applySiliconFlowConfig(config: OpenClawCNConfig): OpenClawCNConfig {
  return {
    ...config,
    agents: {
      ...config.agents,
 ...
 * 应用 DeepSeek 默认配置
 */
export function applyDeepSeekConfig(config: OpenClawCNConfig): OpenClawCNConfig {
  return {
    ...config,
    agents: {
      ...config.agents,
 ...
 * 应用 DeepSeek 提供商配置
 */
export function applyDeepSeekProviderConfig(config: OpenClawCNConfig): OpenClawCNConfig {
  return {
    ...config,
    models: {
      ...config.models,
 ...
 * 应用智谱 GLM 默认配置
 */
export function applyGlmConfig(config: OpenClawCNConfig): OpenClawCNConfig {
  return {
    ...config,
    agents: {
      ...config.agents,
 ...
 * 应用智谱 GLM 提供商配置
 */
export function applyGlmProviderConfig(config: OpenClawCNConfig): OpenClawCNConfig {
  return {
    ...config,
    models: {
      ...config.models,
 ...
 * 应用阿里云百炼默认配置
 */
export function applyAliyunBailianConfig(config: OpenClawCNConfig): OpenClawCNConfig {
  return {
    ...config,
    agents: {
      ...config.agents,
 ...
 * 应用阿里云百炼提供商配置
 */
export function applyAliyunBailianProviderConfig(config: OpenClawCNConfig): OpenClawCNConfig {
  return {
    ...config,
    models: {
      ...config.models,
 ...
 * 应用火山引擎默认配置
 */
export function applyVolcengineArkConfig(config: OpenClawCNConfig): OpenClawCNConfig {
  return {
    ...config,
    agents: {
      ...config.agents,
 ...
 */
export function applyVolcengineArkProviderConfig(config: OpenClawCNConfig): OpenClawCNConfig {
  return {
    ...config,
    models: {
      ...config.models,
 ...
 * 应用腾讯混元默认配置
 */
export function applyTencentHunyuanConfig(config: OpenClawCNConfig): OpenClawCNConfig {
  return {
    ...config,
    agents: {
      ...config.agents,
 ...
 * 应用腾讯混元提供商配置
 */
export function applyTencentHunyuanProviderConfig(config: OpenClawCNConfig): OpenClawCNConfig {
  return {
    ...config,
    models: {
      ...config.models,
