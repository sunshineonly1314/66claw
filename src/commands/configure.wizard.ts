...
async function promptConfigureSection(
  ...
  return guardCancel(
    await select<ConfigureSectionChoice>({
      message: t("configure.selectSections"),
      options: [
        ...CONFIGURE_SECTION_OPTIONS,
        {
          value: "__continue",
          label: t("configure.continue"),
          hint: hasSelection ? t("configure.done") : t("common.skipForNow"),
        },
      ],
...
async function promptChannelMode(runtime: RuntimeEnv): Promise<ChannelsWizardMode> {
  return guardCancel(
    await select({
      message: t("configure.channels"),
      options: [
        {
          value: "configure",
          label: t("configure.configureLink"),
          hint: t("configure.configureLinkHint"),
        },
        {
          value: "remove",
          label: t("configure.remove"),
          hint: t("configure.removeHint"),
        },
      ],
