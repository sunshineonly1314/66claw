...
describe("matchesMentionWithExplicit", () => {
  ...
  it("skips mentionPatterns when explicit mention resolution is available and bot is not mentioned", () => {
    ...
    // When explicit resolution is available and someone else is mentioned (not the bot),
    // regex patterns are intentionally not checked to avoid false positives.
