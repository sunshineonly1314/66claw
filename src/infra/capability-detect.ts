 ...
 * 从配置路径获取值
 */
function getConfigValue(config: ClawdbotConfig | undefined, path: string): unknown {
 ...
 * 检测渠道配置状态
 */
function detectChannels(config?: ClawdbotConfig): DetectedCapability[] {
  const results: DetectedCapability[] = [];
