...
export const BUILTIN_CAPABILITY_CARDS: ModelCapabilityCard[] = [
  ...
  // ── Google ──
  {
    ...
    capabilities: { text: 5, code: 5, vision: 5, audio: 4, video: 4, toolCall: 5 },
    modelType: "chat",
    region: "international",
    costTier: "premium",
    costPer1M: 10.0,
  ...
  },
  {
    ...
    capabilities: { text: 5, code: 4, vision: 5, audio: 4, video: 4, toolCall: 4 },
    modelType: "chat",
    region: "international",
    costTier: "standard",
    costPer1M: 5.0,
  ...
  },
  {
    ...
    capabilities: { text: 4, code: 4, vision: 4, audio: 3, video: 3, toolCall: 4 },
    modelType: "chat",
    region: "international",
    costTier: "free",
    costPer1M: 0,
  ...
  },
  {
    ...
    capabilities: { text: 4, code: 3, vision: 4, audio: 3, video: 3, toolCall: 4 },
    modelType: "chat",
    region: "international",
    costTier: "free",
    costPer1M: 0,
  ...
  },
  {
    ...
    displayName: "豆包 Seed 2.0 Mini (OpenRouter)",
  ...
  // ── Doubao (ByteDance) ──
  {
    ...
    capabilities: { text: 5, code: 4, vision: 4, video: 3 },
    modelType: "chat",
    region: "domestic",
    costTier: "standard",
    costPer1M: 3.2,
  ...
  // ── DashScope Qwen-Image (千问画图) ──
  {
    provider: "dashscope",
    modelId: "qwen-image-max",
    displayName: "千问 Image Max",
    capabilities: { imageGen: 5 },
    modelType: "specialized",
    region: "domestic",
    costTier: "standard",
  ...
  },
  {
    ...
    displayName: "Z-Image Turbo (快速画图)",
    capabilities: { imageGen: 3 },
    modelType: "specialized",
    region: "domestic",
    costTier: "standard",
    costPer1M: 0.5,
    tags: ["fast", "chinese-optimized"],
  },
  ...
  // ── SiliconFlow video models ──
  {
    ...
    displayName: "SiliconFlow Wan2.2 文生视频",
    capabilities: { videoGen: 5 },
    modelType: "specialized",
    region: "domestic",
    costTier: "standard",
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // Domestic — TTS / ASR Cloud Services
  // ═══════════════════════════════════════════════════════════════════════════

  // ── DashScope Qwen3 TTS (千问语音合成) ──
  {
    provider: "dashscope",
    modelId: "qwen3-tts-instruct-flash",
    displayName: "千问3 TTS Flash",
    aliases: ["qwen3-tts-instruct-flash-2026-01-26"],
    capabilities: { tts: 4 },
    modelType: "specialized",
    region: "domestic",
    costTier: "standard",
    costPer1M: 0.5,
    ttsEngine: "dashscope-qwen3",
  ...
  },
  {
    ...
    displayName: "千问3 TTS Flash 流式",
    aliases: ["qwen3-tts-instruct-flash-realtime-2026-01-22"],
    capabilities: { tts: 4 },
    modelType: "specialized",
    region: "domestic",
    costTier: "standard",
    costPer1M: 0.5,
    ttsEngine: "dashscope-qwen3-realtime",
    languages: ["zh", "en", "ja", "ko"],
    tags: ["streaming", "chinese-optimized"],
  },
  {
    provider: "dashscope",
    modelId: "qwen3-tts-vd-realtime-2026-01-15",
    displayName: "千问3 TTS-VD 流式 (声音设计)",
    aliases: ["qwen3-tts-vd-realtime-2025-12-16"],
    capabilities: { tts: 4 },
    modelType: "specialized",
    region: "domestic",
    costTier: "standard",
    costPer1M: 1.0,
    ttsEngine: "dashscope-qwen3-vd",
    languages: ["zh", "en"],
    tags: ["streaming", "voice-design", "chinese-optimized"],
  },
  {
    provider: "dashscope",
    modelId: "qwen3-tts-vd-2026-01-26",
    displayName: "千问3 TTS-VD (声音设计)",
    capabilities: { tts: 4 },
    modelType: "specialized",
    region: "domestic",
    costTier: "standard",
    ...
    ttsEngine: "dashscope-qwen3-vd",
    languages: ["zh", "en"],
    tags: ["voice-design", "chinese-optimized"],
  },
  {
    provider: "dashscope",
    modelId: "qwen3-tts-vc-realtime-2026-01-15",
    displayName: "千问3 TTS-VC 流式 (声音克隆)",
    aliases: ["qwen3-tts-vc-2026-01-22"],
    capabilities: { tts: 5 },
    modelType: "specialized",
    region: "domestic",
    costTier: "standard",
    costPer1M: 1.5,
    ttsEngine: "dashscope-qwen3-vc",
    languages: ["zh", "en"],
    tags: ["streaming", "voice-clone", "chinese-optimized"],
  },
  {
    provider: "dashscope",
    modelId: "qwen-voice-design",
    displayName: "千问 Voice Design (声音定制)",
    capabilities: { tts: 3 },
    modelType: "specialized",
    region: "domestic",
    costTier: "standard",
    costPer1M: 1.0,
    ttsEngine: "dashscope-voice-design",
    languages: ["zh", "en"],
    tags: ["voice-design", "chinese-optimized"],
  },

  // ── DashScope Qwen3 ASR (千问语音识别) ──
  {
    provider: "dashscope",
    modelId: "qwen3-asr-flash",
    displayName: "千问3 ASR Flash",
    aliases: ["qwen3-asr-flash-realtime-2026-02-10"],
  ...
  },
  {
    ...
    displayName: "FunASR Flash 8K 流式",
    aliases: ["fun-asr-flash-8k-realtime-2026-01-28"],
    capabilities: { audio: 3 },
    modelType: "specialized",
    region: "domestic",
    costTier: "standard",
    costPer1M: 0.3,
  ...
  // ── Doubao additional models (ByteDance) ──
  {
    ...
    capabilities: { text: 4, code: 3, vision: 3, video: 2 },
    modelType: "chat",
    region: "domestic",
    costTier: "standard",
    costPer1M: 0.6,
  ...
  // ── Qwen 3.5 系列 ──
  {
    ...
    aliases: ["qwen3.5-plus-2026-02-15", "qwen/qwen3.5-plus-02-15"],
    capabilities: { text: 5, code: 4, vision: 4, toolCall: 4 },
    modelType: "chat",
    region: "domestic",
    costTier: "standard",
    costPer1M: 2.4,
  ...
  },
  {
    ...
    displayName: "千问 3.5 Flash",
    aliases: ["qwen3.5-flash-2026-02-23"],
    capabilities: { text: 4, code: 4, vision: 4, toolCall: 4 },
    modelType: "chat",
    region: "domestic",
    costTier: "standard",
    costPer1M: 0.4,
    maxContextTokens: 1_000_000,
    tags: ["fast", "long-context", "chinese-optimized"],
  },
  {
    provider: "qwen",
    modelId: "qwen3.5-397b-a17b",
    displayName: "千问 3.5 397B-A17B (MoE)",
    capabilities: { text: 5, code: 5, vision: 4, toolCall: 4 },
    modelType: "chat",
    region: "domestic",
    costTier: "premium",
    costPer1M: 3.5,
  ...
  },
  {
    ...
    displayName: "千问 3.5 122B-A10B (MoE)",
    capabilities: { text: 4, code: 4, vision: 4, toolCall: 4 },
    modelType: "chat",
    region: "domestic",
    costTier: "standard",
  ...
  },
  {
    ...
    displayName: "千问 3.5 35B-A3B (MoE)",
    capabilities: { text: 4, code: 3, vision: 3, toolCall: 3 },
    modelType: "chat",
    region: "domestic",
    costTier: "standard",
    costPer1M: 0.4,
  ...
  },
  {
    ...
    displayName: "Qwen-Image-Edit-2509 (图像编辑)",
    aliases: ["qwen-image-edit-2509"],
