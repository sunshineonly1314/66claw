...
export const normalizePluginsConfig = (
  config?: OpenClawCNConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: OpenClawCNConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: OpenClawCNConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: OpenClawCNConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }
