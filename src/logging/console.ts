...
type ConsoleConfigLoader = () => OpenClawCNConfig["logging"] | undefined;
...
function normalizeConsoleLevel(level?: string): LogLevel {
  ...
  if (!level && process.env.VITEST === "true" && process.env.OPENCLAWCN_TEST_CONSOLE !== "1") {
    return "silent";
  }
...
function resolveConsoleSettings(): ConsoleSettings {
  let cfg: OpenClawCNConfig["logging"] | undefined =
