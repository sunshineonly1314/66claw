...
export const FIELD_HELP: Record<string, string> = {
  "meta.lastTouchedVersion": "Auto-set when OpenClawCN writes the config.",
  ...
  "gateway.controlUi.basePath":
    "Optional URL prefix where the Control UI is served (e.g. /openclawcn).",
  ...
  "diagnostics.cacheTrace.filePath":
    "JSONL output path for cache trace logs (default: $OPENCLAWCN_STATE_DIR/logs/cache-trace.jsonl).",
  ...
  "tools.web.search.provider":
    'Search provider ("brave", "perplexity", "grok", "bing", or "bocha").',
  ...
  "memory.backend": 'Memory backend ("builtin" for OpenClawCN embeddings, "qmd" for QMD sidecar).',
  ...
  "plugins.installs":
    "CLI-managed install metadata (used by `openclawcn plugins update` to locate install sources).",
