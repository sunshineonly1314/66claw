...
<body>
  ...
  <main class="main-container">
    ...
    <div id="page2" class="card hidden">
      ...
      <div class="simple-agreement">
        ...
        <div class="agreement-disclaimer">
          虽然 AI 现在很强大，但 AI 生成内容可能存在随机性或偏差。使用 ClawdBotCN 即表示你已了解风险：我们不对 AI 产生的任何错误或潜在风险承担法律责任。请理性对待，安全使用哦~
        </div>
      </div>
          ...
          <div id="dingtalkGuide" class="channel-guide hidden">
              ...
              <div class="guide-step">
                ...
                <div class="guide-step-content">
                  ...
                  <div class="guide-step-desc">
                    ...
                    ✅ 不需要有公网 IP<br>
                    ✅ 不需要配置域名和 HTTPS<br>
                    ✅ 在自己电脑上运行 Clawdbot 就能收到消息<br><br>
            ...
            <div class="guide-faq">
              ...
              <div class="guide-faq-item">
                ...
                <div class="guide-faq-a">A: 检查：1) 应用是否已发布 2) 是否选择了 Stream 模式 3) Clawdbot Gateway 是否正在运行</div>
              </div>
            </div>
          ...
          <div id="wecomGuide" class="channel-guide hidden">
            ...
            <div class="guide-content">
              ...
              <div class="guide-step">
                ...
                <div class="guide-step-content">
                  ...
                  <div class="guide-step-desc">
                    ...
                    <span class="guide-tip">⚠️ <strong>重要</strong>：先<strong>不要点保存</strong>！因为保存时企业微信会立即验证你的回调地址，如果 Clawdbot 还没启动，验证会失败。<br>
                    请先把 Token 和 EncodingAESKey 复制填到下方，启动 Clawdbot 后再回来点保存</span>
                  </div>
                </div>
              </div>
              ...
              <div class="guide-step">
                <div class="guide-step-number">6</div>
                <div class="guide-step-content">
                  <div class="guide-step-title"><strong>填写下方配置并启动 Clawdbot</strong></div>
                  <div class="guide-step-desc">
                    <ol class="guide-substeps">
                      ...
                      <li>确保 Clawdbot Gateway 已经启动</li>
                    </ol>
                  </div>
                </div>
              </div>
              ...
              <div class="guide-step">
                ...
                <div class="guide-step-content">
                  ...
                  <div class="guide-step-desc">
                    <ol class="guide-substeps">
                      <li>Clawdbot 启动后，回到企业微信后台的「设置API接收」页面</li>
      ...
      <div id="licenseFormSection">
        ...
        <div class="why-choose-section">
          <div class="why-choose-header">
            ...
            <span class="why-choose-title">为什么选择 ClawdBotCN？</span>
          </div>
    ...
    <div id="page5" class="card hidden">
      ...
      <button class="launch-button" id="launchButton" onclick="launchClawdbot()">
        <span class="material-icons">rocket_launch</span>
        开始使用 ClawdbotCN
      </button>
    </div>
  ...
  <script>
    ...
    function completeStep4() {
      ...
      console.log('Agreement accepted:', agreementRecord);
    ...
    function showLegalModal(type) {
      ...
      const contents = {
        userAgreement: {
          ...
          content: \`
            <h4>第一条 总则</h4>
            <p>欢迎使用 ClawdbotCN 软件（以下简称"本软件"）。本协议是您与 tecbinAI 团队之间关于使用本软件的法律协议。</p>
    ...
    async function launchClawdbot() {
      ...
      const gatewayToken = window.__GATEWAY_TOKEN__ || 'clawdbot2026';
      console.log('[Setup] Gateway token:', gatewayToken);
  ...
  if (platformInfo.os === 'macOS') {
    ...
    if (platformInfo.variant === 'pro') {
      return `
        ...
        <li>工作目录位于: <code>D:\\Clawdbot\\workspace</code></li>
      `;
    } else {
      return `
        <li>工作目录位于: <code>D:\\Clawdbot\\workspace</code></li>
