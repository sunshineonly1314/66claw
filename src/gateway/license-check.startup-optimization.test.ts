...
function cnConfig(overrides?: Partial<ClawdbotConfig>): ClawdbotConfig {
  return { license: { key: "test-key-123" }, ...overrides } as ClawdbotConfig;
}

// Helper: create a non-CN config
function nonCnConfig(): ClawdbotConfig {
