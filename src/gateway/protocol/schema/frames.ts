...
/**
 * Broadcast before a graceful restart to notify clients the gateway is entering
 * drain mode. Clients should stop sending new requests and prepare for reconnection.
 */
export const DrainingEventSchema = Type.Object(
  {
    reason: NonEmptyString,
