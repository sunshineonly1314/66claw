...
export const ProtocolSchemas: Record<string, TSchema> = {
  ...
  SkillsRemoteListParams: SkillsRemoteListParamsSchema,
  SkillsRemoteListResult: SkillsRemoteListResultSchema,
  RemoteSkillMeta: RemoteSkillMetaSchema,
  SkillsMarketListParams: SkillsMarketListParamsSchema,
  SkillsMarketListResult: SkillsMarketListResultSchema,
  SkillsMarketRefreshParams: SkillsMarketRefreshParamsSchema,
  MarketSkillMeta: MarketSkillMetaSchema,
