...
export const DEFAULT_CLI_NAME = "openclawcn";

const KNOWN_CLI_NAMES = new Set([DEFAULT_CLI_NAME, "openclawcn"]);
const CLI_PREFIX_RE = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(openclawcn|openclawcn)\b/;
