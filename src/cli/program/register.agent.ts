...
${formatHelpExamples([
  ['openclawcn agent --to +15555550123 --message "status update"', "Start a new session."],
  ['openclawcn agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
  ...
  ['openclawcn agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.openclawcn.ai/cli/agent")}`,
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.openclawcn.ai/cli/agents")}\n`,
    );
...
${formatHelpExamples([
  ...
  [
    "openclawcn agents set-identity --identity-file ~/.openclawcn/workspace/IDENTITY.md --agent main",
